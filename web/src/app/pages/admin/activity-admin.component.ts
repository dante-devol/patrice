...
const CATEGORIES: { label: string; prefix: string }[] = [
  ...
  { label: 'Request Templates', prefix: 'request_template' },
...
const VERB_LABELS: Record<string, string> = {
  ...
  'task_request_template.updated': 'edited a task request template',
  ...
  'request_template.updated': 'edited a division request template',
  ...
  'integration.push_failed': 'couldn’t update a Discord role (check the bot’s permissions)',
